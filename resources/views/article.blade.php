                ...
                <div class="lg:col-span-3 order-1 lg:order-2">
                    ...
                    <div class="mt-12 card bg-base-200 shadow-xl">
                        <div class="card-body flex-row gap-6 items-center">
                            <div class="avatar">
                                <div class="w-20 rounded-full bg-gradient-to-br from-primary to-primary-focus flex items-center justify-center text-white font-bold text-2xl">
                                    {{ substr($post->author->name, 0, 2) }}
                                </div>
                            </div>
                            <div>
                                <h3 class="text-xl font-bold">{{ $post->author->name }}</h3>
                                <p class="text-base-content/70">{{ $post->author->email }}</p>
                                <div class="mt-2 flex gap-2">
                                    <span class="badge badge-primary">Author</span>
                                    <span class="badge badge-ghost">{{ $post->author->posts()->count() }} Artikel</span>
                                </div>
                            </div>
                        </div>
                    </div>
