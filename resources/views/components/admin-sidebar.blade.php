<div class="menu p-4 w-80 min-h-full bg-base-100 text-base-content border-r border-base-300">
    <div class="mb-6 px-4 hidden lg:block">
        <a href="{{ route('admin.dashboard') }}" class="text-2xl font-bold text-primary flex items-center gap-2">
            <!-- You can use an img tag here if you have a logo file -->
