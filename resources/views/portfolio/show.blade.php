                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-medium text-base-content">{{ implode(', ', $portfolio->tags) }}</p>
                                    </div>
                                </div>
                                @endif
                                ...
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        <p class="text-xs font-semibold uppercase text-base-content/60">Tahun</p>
                                        <p class="font-medium text-base-content">{{ $portfolio->published_at ? $portfolio->published_at->format('F Y') : $portfolio->created_at->format('F Y') }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
