<x-layouts.admin title="Tambah Tech Stack">
    <div class="mx-auto max-w-2xl">
        <div class="flex items-center gap-4 mb-6">
            ...
            <h1 class="text-2xl font-bold">Tambah Tech Stack</h1>
        </div>
            ...
            <div class="card-body">
                <form action="{{ route('admin.tech-stacks.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-control w-full mb-4">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" placeholder="Contoh: Laravel, React, Photoshop" class="input input-bordered w-full @error('name') input-error @enderror" required />
                        @error('name')
                            <label class="label">
                    ...
                    <div class="form-control w-full mb-6">
                        <label class="label">
                            ...
                            <span class="label-text-alt">Format: PNG, JPG, SVG (Max 2MB)</span>
                        </label>
                    ...
                    <div class="card-actions justify-end">
                        <button type="submit" class="btn btn-primary text-white">Simpan Tech Stack</button>
                    </div>
                </form>
            </div>
        </div>
