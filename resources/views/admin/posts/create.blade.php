<x-layouts.admin title="Admin - Create Post">
    <div class="mx-auto max-w-4xl">
        ...
        <div class="card bg-base-100 shadow">
            <div class="card-body">
                <form method="POST" action="{{ route('admin.posts.store') }}" enctype="multipart/form-data" class="space-y-6" x-data="blockEditor()">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="form-control">
                            ...
                            <input type="text" name="title" required class="input input-bordered w-full" placeholder="Enter post title" />
                        </div>
                        <div class="form-control">
                            <label class="label"><span class="label-text">Slug</span></label>
                            <input type="text" name="slug" class="input input-bordered w-full" placeholder="auto-generated-slug" />
                        </div>
                    </div>
                        ...
                        <div class="collapse-content space-y-4 pt-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="form-control">
                                    ...
                                    <input type="text" name="meta_title" class="input input-bordered w-full" placeholder="Optional SEO Title" />
                                </div>
                                <div class="form-control">
                                    <label class="label"><span class="label-text">Keywords</span></label>
                                    <input type="text" name="keywords" class="input input-bordered w-full" placeholder="comma, separated, tags" />
                                </div>
                            </div>
                            <div class="form-control">
                                <label class="label"><span class="label-text">Meta Description</span></label>
                                <textarea name="meta_description" class="textarea textarea-bordered h-24" placeholder="SEO Description"></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-end gap-2 pt-6">
                        ...
                        <button type="submit" class="btn btn-primary text-white px-8">Create Post</button>
                    </div>
                </form>
            </div>
        </div>
